...
export const articles: Article[] = [
  {
    id: '98437339',
    title: '"Glump" Is the Internet\'s New Name for Online Market Traders',
    summary:
      'A new piece of internet slang is beginning to make the rounds in online trading communities: "Glump," a term being used to describe the new generation of traders who spend their days watching charts, chasing market moves and living almost entirely inside online financial communities.',
    body: [
      'August 10, 2026 — The internet has created countless names for people participating in financial markets, from "day traders" and "degens" to "apes" and "diamond hands." Now, another word is attempting to enter the online trading vocabulary: Glump.',
      'The term is being used as a playful nickname for people who actively trade markets online, particularly those deeply immersed in the fast-moving world of stocks, cryptocurrency, prediction markets and speculative assets.',
      'Instead of saying, "I\'m an online trader," someone might simply say:',
      '"I\'m a Glump."',
      'And a group of traders?',
      '"The Glumps are trading again."',
      {
        type: 'heading',
        text: 'What Exactly Is a Glump?',
      },
      'A Glump is essentially an internet-native market trader.',
      'The word describes someone who spends a significant amount of time monitoring markets, studying charts, following financial news and jumping between trading platforms while discussing every move with other traders online.',
      'Glumps aren\'t necessarily professional Wall Street traders sitting inside major financial institutions. In fact, the term represents almost the opposite.',
      'A Glump can be sitting at home with three monitors, trading from a laptop in a café or checking a position from a phone at 2 a.m.',
      'The market never really leaves their mind.',
      'When prices rise, they\'re watching.',
      'When prices crash, they\'re watching.',
      'And when absolutely nothing is happening, they\'re still watching.',
      'That\'s the Glump lifestyle.',
      {
        type: 'heading',
        text: 'From "Trader" to "Glump"',
      },
      'Internet culture has a long history of transforming serious financial terminology into memes.',
      'During previous market cycles, online communities popularized expressions such as "HODL," "diamond hands," "paper hands," "degen" and "ape." Many began as jokes before becoming recognizable pieces of internet financial culture.',
      'Glump could represent the next evolution of that language.',
      'Unlike "investor," which often implies holding assets for months or years, Glump has a much more chaotic meaning.',
      'A Glump is online.',
      'A Glump is watching.',
      'A Glump is trading.',
      'Most importantly, a Glump is always looking for the next move.',
      {
        type: 'heading',
        text: 'The Rise of the Glump Economy',
      },
      'Trading itself has changed dramatically.',
      'Financial markets that once required brokers, phone calls and specialized terminals can now be accessed instantly from smartphones. Stocks, cryptocurrencies and other markets have increasingly become part of internet culture.',
      'That shift has created an entirely different type of market participant.',
      'They consume memes alongside financial news.',
      'They discuss trades in group chats.',
      'They watch charts while watching livestreams.',
      'They might discover an asset through a viral post and open a position minutes later.',
      'Traditional terminology doesn\'t always capture that culture.',
      'That\'s where Glump comes in.',
      'The word isn\'t meant to describe a specific trading strategy. A Glump could be bullish, bearish, profitable, completely wrecked or somehow all four within the same afternoon.',
      'It describes the person behind the screen.',
      {
        type: 'heading',
        text: '"Once a Glump, Always a Glump"',
      },
      'The humor surrounding the term comes from how recognizable the lifestyle can be.',
      'A Glump might promise to stop trading for the day before reopening the chart five minutes later.',
      'A Glump might celebrate a 20% gain and then spend the next six hours trying to recover the money lost immediately afterward.',
      'A Glump might have 14 browser tabs open, three charts running and absolutely no idea what they\'re eating for dinner.',
      'Yet tomorrow morning, they\'re back.',
      'That persistence—or perhaps inability to look away—is part of what gives the term its identity.',
      {
        type: 'heading',
        text: 'Could "Glump" Actually Catch On?',
      },
      'Internet language is unpredictable.',
      'Some phrases disappear within days. Others begin as tiny community jokes and eventually spread across platforms until millions of people understand them.',
      'Whether Glump becomes permanent trading vocabulary will ultimately depend on whether online communities adopt it.',
      'But the word fits an increasingly recognizable generation of traders: highly online, permanently connected and capable of moving between serious financial analysis and absurd internet memes within seconds.',
      'Markets have bulls.',
      'Markets have bears.',
      'The internet had degens.',
      'Now it might have Glumps.',
      'And if the term catches on, the next time markets suddenly begin moving, there may be a much simpler explanation:',
      'The Glumps are online.',
    ],
    category: 'Finance',
    time: '14:13',
    section: 'finance',
    image: glumpHeaderImage,
